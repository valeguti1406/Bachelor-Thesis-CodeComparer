...
/**
 * Listener for the XDebuggerManager in IntelliJ. This class listens for the start of new debugging
 * sessions and adds a session-specific listener to handle custom debugging behavior.
 */
public class DebuggerManagerListener implements XDebuggerManagerListener {

  /**
   * Invoked when a new debugging process starts. Adds a custom session listener
   * (`DebugSessionListener`) to the debugging session.
   *
