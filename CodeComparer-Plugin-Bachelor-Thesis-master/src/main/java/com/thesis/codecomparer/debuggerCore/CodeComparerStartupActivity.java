...
/**
 * A startup activity that runs automatically after a project is fully loaded in IntelliJ. This
 * version implements the modern coroutine-based ProjectActivity interface, compatible with the
 * latest IntelliJ Platform SDKs (2022.3+).
 */
public class CodeComparerStartupActivity implements ProjectActivity {
  ...
  /**
   * This method is automatically called by IntelliJ after the project has been initialized. It runs
   * as a coroutine (suspend function in Kotlin), which is why it uses a Continuation parameter.
   *
   * @param project The current IntelliJ project.
   * @param continuation Internal Kotlin continuation mechanism for coroutines (automatically
   *     handled by IntelliJ).
